...
def convert_to_str_paths(filenames):
    """Converts filenames to string paths, handling both string and pathlib.Path objects and lists of such objects.

    Args:
        filenames (str or list[str] or Path or list[Path]): filepath(s) to convert to str object(s)
    Raises:
        TypeError: If any of the filenames is not a str or pathlib.Path object
    """
